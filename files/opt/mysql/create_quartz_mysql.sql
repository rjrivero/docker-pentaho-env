...
CREATE DATABASE IF NOT EXISTS `%PREFIX%quartz` DEFAULT CHARACTER SET latin1;

grant all on %PREFIX%quartz.* to '%PREFIX%pentaho_user'@'localhost' identified by '%PASSWORD%';
grant all on %PREFIX%quartz.* to '%PREFIX%pentaho_user'@'%' identified by '%PASSWORD%';
